...
class Auth extends CI_Controller
{
	...
	{
		if ($this->ion_auth->logged_in()) redirect('admin/dashboard');
	 ...
	 */
	public function _reset_password($code = NULL)
	{
		if (!$code)
		{
			show_404();
	 ...
	 */
	public function _activate($id, $code = FALSE)
	{
		if ($code !== FALSE)
		{
	 ...
	 */
	public function _deactivate($id = NULL)
	{
	...
	*/
	 ...
	 * @param int|string $id
	 */
	public function _edit_group($id)
	{
